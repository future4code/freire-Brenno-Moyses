...
import { IDeleteUsersInputDTO, IGetUseResponseOutputDTO, IGetUserResponseOutputDTO, IGetUsersInputDTO, ILoginInputDTO, ISignupInputDTO, ISignupOutputDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: IGetUsersInputDTO) => {
        ...
        const users = usersDB.map(userDB => {
            ...
            const userResponse: IGetUserResponseOutputDTO = {
                id: user.getId(),
                name: user.getName(),
                email: user.getEmail()
            }
